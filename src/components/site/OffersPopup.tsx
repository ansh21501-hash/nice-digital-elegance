    ...
    >
      ...
      >
        ...
        <div className="p-7 text-center">
          <p className="flex items-center justify-center gap-1.5 text-xs uppercase tracking-[0.3em] text-gold">
            <Tag className="h-3.5 w-3.5" /> Special Offers
          </p>
          <h2 className="mt-2 font-display text-3xl text-charcoal">{main.title}</h2>
          {main.description && (
            <p className="mt-2 text-sm text-muted-foreground">{main.description}</p>
          )}
