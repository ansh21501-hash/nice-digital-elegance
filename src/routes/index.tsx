  ...
  head: () => ({
    meta: [
      { title: "Nice Hotel And Restaurant — Luxury Hotel & Fine Dining in Mansa, Punjab" },
      {
        name: "description",
        content:
          "Welcome to Nice Hotel And Restaurant in Mansa, Punjab — 9 luxury rooms, a fine dining restaurant and an elegant party hall. Where luxury meets comfort.",
      },
  ...
  errorComponent: () => (
    <div className="container-luxe flex min-h-[60vh] flex-col items-center justify-center py-24 text-center">
      ...
      <p className="mt-3 text-muted-foreground">
        We're having a brief hiccup loading this page. Please refresh, or call us at {site.phone}.
      </p>
    </div>
  ),
  notFoundComponent: () => (
    <div className="container-luxe flex min-h-[60vh] flex-col items-center justify-center py-24 text-center">
      ...
      <Link to="/" className="mt-4 text-gold underline">
        Back to home
      </Link>
    </div>
  ),
    ...
    <Reveal delay={0.3} className="container-luxe relative z-20 -mt-20">
      <div className="glass grid grid-cols-1 gap-3 rounded-2xl p-5 shadow-luxe sm:grid-cols-2 lg:grid-cols-5">
        <label className="text-[0.65rem] uppercase tracking-wider text-muted-foreground">
          Check-in
          <input type="date" className={`${field} mt-1`} aria-label="Check-in" />
        </label>
        <label className="text-[0.65rem] uppercase tracking-wider text-muted-foreground">
          Check-out
          <input type="date" className={`${field} mt-1`} aria-label="Check-out" />
        </label>
        <label className="text-[0.65rem] uppercase tracking-wider text-muted-foreground">
          Guests
          <input
    ...
    <>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="container-luxe relative z-10 text-center">
          ...
          >
            Premium Hospitality · Mansa, Punjab
          </motion.p>
          <motion.h1
          ...
          >
            Premium Accommodation — Luxury Rooms &amp; Suites. Experience refined hospitality where
            comfort, elegance and unforgettable memories come together.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <Link to="/rooms">
              <LuxeButton variant="outline">
                <span className="text-ivory">Explore Our Rooms</span>
              </LuxeButton>
            </Link>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2">
          <Reveal>
            ...
            <p className="mt-6 text-muted-foreground">
              Nice Hotel &amp; Restaurant is where elegance meets comfort. With beautifully designed
              luxury rooms, a fine dining restaurant and an elegant party hall, we bring world-class
              hospitality to the heart of Mansa.
            </p>
            <p className="mt-4 text-muted-foreground">
              Located in the centre of the city, we offer personalized service to make your stay
              truly memorable.
            </p>
            ...
            <div className="mt-8">
              <Link to="/about">
                <LuxeButton variant="outline">
                  <span className="text-charcoal">Discover More</span>
                </LuxeButton>
              </Link>
            </div>
          </Reveal>
      ...
      <section className="container-luxe py-24">
                ...
                <div className="group overflow-hidden rounded-2xl bg-ivory shadow-luxe">
                  <div className="relative h-64 overflow-hidden">
                    <AppImage
                      ...
                      loading="lazy"
                    />
                    <span className="absolute left-4 top-4 rounded-full bg-gold px-3 py-1 text-xs font-medium uppercase tracking-wider text-ivory">
                      {r.badge}
                    </span>
        ...
        <div className="mt-12 text-center">
          <Link to="/rooms">
            <LuxeButton>View All Rooms</LuxeButton>
          </Link>
        </div>
      </section>
      ...
      <section className="container-luxe py-24">
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2">
          ...
          <Reveal delay={0.15} className="order-1 lg:order-2">
            ...
            <div className="gold-rule mt-5" />
            <p className="mt-6 text-muted-foreground">
              From intimate functions to lively celebrations, our elegant party hall and flexible
              spaces are tailored to suit every occasion. Perfect for kitty parties, birthdays and
              social gatherings of up to 100 guests.
            </p>
            <div className="mt-6 flex flex-wrap gap-2">
              {["Stage", "Sound System", "Chandeliers", "Dance Floor", "Catering"].map((f) => (
                <span key={f} className="rounded-full bg-beige px-4 py-1.5 text-xs text-brown">
                  {f}
                </span>
              ))}
            </div>
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <LuxeButton variant="outline" onClick={() => open()}>
                <span className="text-charcoal">Inquire Now</span>
              </LuxeButton>
            </div>
          </Reveal>
        </div>
